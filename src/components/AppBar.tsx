      ...
      <header id="navbar-sticky" className="navbar">
        <div className="container">
          <nav>
            ...
            <div className="ms-auto flex items-center ppx-2.5 lg:hidden">
              <button
            ...
            <div
              className="hs-collapse mx-auto mt-2 hidden grow basis-full items-center justify-center translation-all duration-300 lg:mt-0 lg:flex lg:basis-auto"
              id="mobileMenu"
            >
