                ...
                <form onSubmit={handleSubmit} className="mb-6 space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="hover:bg-primary-hover hover:border-primary-hover border-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center gap-2 rounded-md px-6 text-white transition-all"
                    >
                      Subscribe
                    </button>
                  </div>
                  ...
                  <ul className="flex flex-wrap items-center gap-1">
                    {[
                      ...
                      <li key={index}>
                        <a
                          href="#"
                          className="hover:bg-primary group incline-flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 transition-all duration-500"
                        >
                          <i
